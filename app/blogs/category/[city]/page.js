...
export async function generateMetadata({ params }, parent) {
  return {
    ...parent,
    alternates: {
      canonical: `https://globalhomes.ca/blogs/category/${params?.city}`,
    },
    title: `Globalhomes Blogs | ${params?.city} Insights on real Estate`,
  };
}
              ...
              <div className="row g-4">
                <div className="col-sm-12 col-lg-12">
                  <h1 className="main-title text-center text-md-start mb-4">
                    The Globalhomes Blog : Learn whats happening in your city
                  </h1>
        ...
        <div className="py-5 my-5 d-none d-md-block">
          <div className="container-fluid">
            ...
            <h2 className="fw-mine text-center px-md-4 fs-4">
              Contact Globalhomes Team Today
            </h2>
