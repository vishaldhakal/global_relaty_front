  ...
  return (
    <>
      <div className="card border-0 rounded-mine my-2 my-md-0 pb-5 condocard position-relative mt-5 max-w-mine">
        <div className="builder-logo-detail is-loading d-flex justify-content-center">
          {props.image ? (
            <img
              loading="lazy"
        ...
        <div className="card-content px-4 developer-desc mt-5">
          <h3 className="mb-1 text-dark text-center">{props.name}</h3>
          ...
          <div
            className="iframe-container mb-0 pt-3 text-center container"
